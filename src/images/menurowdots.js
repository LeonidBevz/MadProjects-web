...
const MenuRowDotsIco = ({ color = "white", className = "", onEdit = ()=>{}, onDelete= ()=>{},onRecolor= ()=>{}}) => {
  ...
  return(
    <div className="drop-menu">
      <svg className = { className }  onClick={()=>setIsMenuOpen(!isMenuOpen)} ref={buttonRef} viewBox="0 0 36 35" fill={color} xmlns="http://www.w3.org/2000/svg">
      ...
      {isMenuOpen && (<div className="ddmenu" ref={menuRef} draggable="false">
        <button onClick={handleEdit}>Переименовать</button>
        <button onClick={handleRecolor}>Изменить цвет</button>
